...
>
      <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 lg:gap-20">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/16me8noWi_V9W2be4MaiVk76nl6Nbi0Bu/view?usp=sharing"
            target="_blank"
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <Tilt
            className="w-55 h-55 sm:w-64 sm:h-64 md:w-[30rem] md:h-[30rem] border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
